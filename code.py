...
trainset = traingen.flow_from_directory('/codeops/cnn_dataset/training_set/' , target_size=(64,64) , batch_size=32 , class_mode='categorical' )
testset = testgen.flow_from_directory('/codeops/cnn_dataset/test_set/' , target_size=(64,64) , batch_size=32 , class_mode='categorical' )
